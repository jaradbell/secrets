...
export function TransactionView() {
  ...
  return (
    // Anchored to the top, tucked under the conversation header (which spans
    // safe-top + 50px of the frame) — a chat reads top-down, not centered.
    <div className="flex w-full flex-col self-stretch justify-start pt-[68px]">
      ...
      {/* Conversation chrome — pinned to the top of the device frame, under
          the details sheet (z-30) so overlays cover it. */}
